...
if [ $1 == '-h' ]; then
    ...
    echo "star date yyyy-mm-dd, end date yyyy-mm-dd, inst. conf, tile, red. folder name, e-mail of user"
    echo ""
    echo ""
    echo "ex:"
...
echo "of individual images for the field $tile."
...
do
    echo ''
    echo ''
    echo "Combining images for $tile  in filter $filt"
    echo ''
    echo ''
    echo ''
    runcoadding.py -u -o $tile $filt
done
wait
